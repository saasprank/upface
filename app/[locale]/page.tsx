  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Bloc 1 — Témoignages (avant tarifs) */}
        ...
        {/* Bloc 2 — Stats */}
        <section className="px-4 py-10" style={{ background: '#0D1321' }}>
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div
                ...
                style={{ background: '#080C14', border: '1px solid rgba(59,130,246,0.12)' }}
              >
        ...
        {/* Bloc 3 — Pourquoi Upface */}
        <section className="px-4 py-12" style={{ background: '#080C14' }}>
            ...
            {[
              {
                ...
                a: "Oui. L'analyse faciale complète est 100% gratuite. Tu reçois ton score global et 3 critères détaillés. La routine complète est disponible en Pro.",
              },
              {
                q: 'Mes photos sont-elles sécurisées ?',
                a: 'Tes photos sont supprimées automatiquement après 30 jours. Nous ne les vendons jamais et elles sont hébergées en Europe (RGPD).',
              },
              {
                q: 'En combien de temps vais-je voir des résultats ?',
                a: 'Les premiers résultats visibles apparaissent en 4 à 8 semaines. La plupart des utilisateurs gagnent entre 5 et 15 points en 2 mois.',
              },
              {
                q: 'Puis-je annuler mon abonnement ?',
                a: 'Oui, à tout moment depuis ton profil. Aucun engagement, aucune pénalité.',
              },
              {
                q: 'Le coach IA est-il vraiment personnalisé ?',
                a: 'Oui. Le coach connaît ton score exact, tes points faibles et ta routine. Généré par GPT-4o et adapté à ton profil unique.',
              },
            ].map((item, i) => (
              <details
                key={i}
